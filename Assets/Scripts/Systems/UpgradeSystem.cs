...
public class UpgradeSystem : MonoBehaviour
{
    ...
    public void Init(PlayerData _playerData, ObjectCreator _objectCreator, CoreUI _coreUI)
    {
        ...
        OnForceSpendUpgraded(forceSpendUpgradeCost, playerData.expCur, playerData.forceSpend, playerData.forceSpendBasic * (float)Math.Pow(0.9f, playerData.upgradeLevels["ForceSpend"] + 1));


        OnProductionTimeUpgraded(productionTimeUpgradeCost, playerData.expCur, playerData.productionTime, playerData.productionTimeBasic * (float)Math.Pow(0.9f, playerData.upgradeLevels["ProductionSpeed"] + 1));
    ...
    public void UpgradeForceSpend()
    {
        if (playerData.expCur >= forceSpendUpgradeCost)
        {
            ...
            OnForceSpendUpgraded(forceSpendUpgradeCost, playerData.expCur, playerData.forceSpend, (float)Math.Pow(0.9f, playerData.upgradeLevels["ForceSpend"] + 1));
        }
    }
